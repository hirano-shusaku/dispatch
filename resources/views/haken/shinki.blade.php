            ...
            <div class="mx-4 sm:p-8">
                    ...
                    <div class="md:flex items-center mt-8">
                     ...
                     <div class="w-full flex flex-col">
                        ...
                        <p>【SOJ】【外注派遣】{{$haken->job}}{{$haken->name}}氏 3か月(新規){{$haken->startday->format('Y/m/d')}}～{{$haken->endday->format('Y/m/d')}}</p>
                     </div>
                    </div><br>
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <p>{{ $haken->startday->format('Y年m月d日') }}～{{ $haken->endday->format('Y年m月d日') }}</p>
